// 1.element.insertAdjacentAdjacentText(position, text)

const h3 = document.querySelector("h3");
// h3.insertAdjacentText("position", "text")
// position : beforebegin, afterbegin, befoeed, afferend
...
// 2. element.inserAdjacentElement(postion, element, node)

const strong = document.createElement("strong");
strong.classList.add("bold");
strong.innerHTML = `<h1>Hoang Anh Dũng</h1>`
